 ...
 *   get:
 *     summary: Get notification counts for user
 *     tags: [Notifications]
 *     security:
 *       - bearerAuth: []
 *     responses:
 ...
 *               type:
 *                 type: string
 *                 enum: [tour_registration, registration_approved, registration_rejected, tour_update, tour_cancelled, system_announcement]
 *               title:
 *                 type: string
 *                 maxLength: 100
 *               message:
 ...
 */
// Public endpoint - no authentication required for VAPID public key
router.get('/vapid-key',
  notificationController.getVapidPublicKey
);

// Test endpoint to verify public access
