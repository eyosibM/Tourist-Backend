...
/**
 * @swagger
 * /api/uploads/tour-media:
 *   post:
 *     summary: Upload tour media (image or video to S3)
 *     tags: [File Uploads]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *                 type: string
 *                 format: binary
 *                 description: Media file (Images - JPEG, PNG, GIF up to 5MB; Videos - MP4, MOV, AVI, MKV, WebM up to 100MB)
 *               title:
 *                 type: string
 ...
 *                 type: string
 *                 enum: [features, teaser]
 *                 description: Type of tour media
 *     responses:
 *       200:
 *         description: Tour media uploaded successfully to S3
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                       type: string
 *                       format: uri
 *                       description: S3 URL of the uploaded media
 *                 fileName:
 *                   type: string
 *                 fileSize:
 *                   type: number
 ...
 *         description: Forbidden - insufficient permissions
 */
router.post('/tour-media',
  authenticate,
  authorize('system_admin', 'provider_admin'),
  mediaUploadMiddleware.single('media_file'),
  uploadController.uploadTourMedia
);
